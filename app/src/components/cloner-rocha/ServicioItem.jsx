        ...
        <tr>
          <td>
            <div className="item-form opc">
              <input type="checkbox" id={`check-importado-${this.props.num}`} name={`check-importado-${this.props.num}`} value={this.props.servicio.CODIGO_SERVICIO}/>
              <label class="checkbox" for={`check-importado-${this.props.num}`}></label>
              <label class="name-check">{this.props.servicio.NOMBRE_SERVICIO}</label>
            </div>
          </td>
          <td><input type="text" readOnly class="active big center" id={`descripcion-${this.props.num}`} /></td>
          <td>
