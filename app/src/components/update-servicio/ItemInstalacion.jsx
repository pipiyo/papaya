...
class ItemInstalacion extends React.Component {
  ...
  constructor(props) {
    ...
    this.state ={
                  ...
                  instalador1:this.validador(props.datos[0].INSTALADOR_1),
                  instalador2:this.validador(props.datos[0].INSTALADOR_2),
                  instalador3:this.validador(props.datos[0].INSTALADOR_3),
                  puestos:this.validador(props.datos[0].PUESTOS),
