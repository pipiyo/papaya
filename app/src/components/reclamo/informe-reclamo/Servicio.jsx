        ...
        <div class="module-actividad">
            ...
            <div class="item-actividad">
                <div class="item-rocha">
                    <h3 class="atrasado" data-key="uno" onClick={this.props.click} ><a> S&S 716-CM-B (R 1001) </a> - Ilustre Municipalidad de Chillán </h3>
                    { uno }
                </div>                            
            </div>
            ...
            <div class="item-actividad">
                <div class="item-rocha">
                    <h3 data-key="dos" onClick={this.props.click} ><a> S&S 2020 (R 1002) </a> - Servicio de Salud Coquimbo </h3>
                    { dos }
                </div>                            
            </div>
