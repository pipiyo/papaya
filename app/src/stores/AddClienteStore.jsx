...
let AddClienteStore = Reflux.createStore({
  listenables: [AddClienteActions],
  obj: { 
    rut: '',
  ...
  addCliente: function(ev){
    ...
    socket.emit('addCliente', cliente, (n) => {
...
export default AddClienteStore