...
db.silla_productos.insert( [{ _id :'AC', name: "Accesorio" },{ _id :'BA', name: "Base"},{ _id :'BR', name: "Brazo"},{ _id :'BU', name: "Butaca"},{ _id :'CA', name: "Cabecero"},{ _id :'ME', name: "Mesa"},{ _id :'PA', name: "Paleta"},{ _id :'PE', name: "Perchero"},{ _id :'PI', name: "Piso Taburete"},{ _id :'PO', name: "Pouf"},{ _id :'RE', name: "Rejilla"},{ _id :'RU', name: "Rueda"},{ _id :'SA', name: "Silla Academica"},{ _id :'SC', name: "Silla Cajero"},{ _id :'SE', name: "Silla Ejecutiva"},{ _id :'SF', name: "Sofa"},{ _id :'SG', name: "Silla Gerencial"},{ _id :'SI', name: "Silla Infantil"},{ _id :'SM', name: "Silla Multiproposito"},{ _id :'SO', name: "Silla Operativa"},{ _id :'ST', name: "Silla Taburete"},{ _id :'SV', name: "Silla Visita"},{ _id :'SR', name: "Servicios"}] )

db.silla_pais.insert( [{ _id : 1, name: "Nacional" },{ _id : 2, name: "Importado"}] )

[{ _id : 1, name: "Nacional" },{ _id : 2, name: "Importado"}]

db.silla_proveedores.insert( [{ _id: 'BO', name: "Bosen"},{ _id: 'CR', name: "Cerantola"},{ _id: 'CT', name: "Contatto"},{ _id: 'DA', name: "Dauphin"},{ _id: 'IN', name: "Indumac"},{ _id: 'KE', name: "Kebel"},{ _id: 'LI', name: "Liberona"},{ _id: 'MM', name: "Mmobili"},{ _id: 'MU', name: "MUMA"},{ _id: 'NS', name: "Nowy Styl"},{ _id: 'OM', name: "OMP"},{ _id: 'SI', name: "Situp"},{ _id: 'ST', name: "Starway"},{ _id: 'VC', name: "VC Industrial"},{ _id: 'S&S', name: "Sillas&Sillas"}] )

[{ _id: 'BO', name: "Bosen"},{ _id: 'CR', name: "Cerantola"},{ _id: 'CT', name: "Contatto"},{ _id: 'DA', name: "Dauphin"},{ _id: 'IN', name: "Indumac"},{ _id: 'KE', name: "Kebel"},{ _id: 'LI', name: "Liberona"},{ _id: 'MM', name: "Mmobili"},{ _id: 'MU', name: "MUMA"},{ _id: 'NS', name: "Nowy Styl"},{ _id: 'OM', name: "OMP"},{ _id: 'SI', name: "Situp"},{ _id: 'ST', name: "Starway"},{ _id: 'VC', name: "VC Industrial"},{ _id: 'S&S', name: "Sillas&Sillas"}]

db.silla_mecanismos.insert( [{ _id: 1, name: "1 cuerpo"},{ _id: 2, name: "2 cuerpo"},{ _id: 3, name: "3 cuerpo"},{ _id: 4, name: "4 cuerpo"},{ _id: 5, name: "5 cuerpo"},{ _id: 6, name: "6 cuerpo"},{ _id: 7, name: "Trineo"},{ _id: 8, name: "fijo"},{ _id: 9, name: "4 patas"},{ _id: 10, name: "pedestal"},{ _id: 11, name: "Pivotal"},{ _id: 12, name: "plato"},{ _id: 13, name: "plegable"},{ _id: 14, name: "Reclinable"},{ _id: 15, name: "Regulable"},{ _id: 16, name: "Syncro"},{ _id: 17, name: "Abatible"},{ _id: 18, name: "Giratoria"}] )

[{ _id: 1, name: "1 cuerpo"},{ _id: 2, name: "2 cuerpo"},{ _id: 3, name: "3 cuerpo"},{ _id: 4, name: "4 cuerpo"},{ _id: 5, name: "5 cuerpo"},{ _id: 6, name: "6 cuerpo"},{ _id: 7, name: "Trineo"},{ _id: 8, name: "fijo"},{ _id: 9, name: "4 patas"},{ _id: 10, name: "pedestal"},{ _id: 11, name: "Pivotal"},{ _id: 12, name: "plato"},{ _id: 13, name: "plegable"},{ _id: 14, name: "Reclinable"},{ _id: 15, name: "Regulable"},{ _id: 16, name: "Syncro"},{ _id: 17, name: "Abatible"},{ _id: 18, name: "Giratoria"}]

db.silla_respaldos.insert( [{ _id: 'A', name: "Alto"},{ _id: 'M', name: "Medio"},{ _id: 'B', name: "Bajo"}] )

[{ _id: A, name: "Alto"},{ _id: M, name: "Medio"},{ _id: B, name: "Bajo"}]

db.silla_tapizes.insert( [{ _id: 'Glock', proovedor: 'Contatto', seq: 1, colores: ["Azul","Azul Caribe","Azul Lago","Azul Piedra-811","Caoba","Esmeralda","Gris Acero","Gris Perla","Negro","Mango","Manzana","Plomo","Rojo","Verde Pino"]},{ _id: 'Escorial', proovedor: 'Contatto', seq: 2, colores: ["Almendra","Arrecife","Azafran","Azul Caribe","Azul Lago","azul Rey","Blue","Burdeo","Caoba","Esmeralda","Gris Acero","Gris Mouse","Gris Nevado","Gris Perla ","Gris Raton","Mango","Naranja","Navy","Negro","Pera","Rojo","Scarlati","Tabaco","Tilo","Tomate","Verde","Vino"]},{ _id: 'Maroqui', proovedor: 'Contatto', seq: 3, colores: []},{ _id: 'Venetto', proovedor: 'Contatto', seq: 4, colores: ["Amarillo","Azul Caribe","Azul Rey","Café","Gris","Naranjo","Negro","Rojo","Verde","Verde Pistacho"]},{ _id: 'Venezia', proovedor: 'Contatto', seq: 5, colores: ["Azul -821","Azul Piedra-811","Bicolor Amarillo -52","Bicolor Azul Noche-53","Bicolor Azul-31","Gris Oscuro-78","Gris-72"]},{ _id: 'Elasticity', proovedor: 'Cerantola', seq: 6, colores: ["Azul 21","Azul 39","Azul 67","Gris 14","Gris 64","Marron 07","Naranjo 65","Negro 60","Rojo 68","Verde 66"]},{ _id: 'Pegaso', proovedor: 'Cerantola', seq: 7, colores: ["Negro 562","Rojo 582","Naranjo 558","Pistacho 569","Café 552"]},{ _id: 'Coventry', proovedor: 'Cerantola', seq: 8, colores: ["Negro"]},{ _id: 'Renna', proovedor: 'Cerantola', seq: 9, colores: ["Amarillo 86","Azul 957","Azul Marino 8","Beige 730","Blanco Invierno 126","Burdeo 7","Celeste Azul 120","Grafito 620","Lila 83","Morado 82","Negro 9","Pistacho 71","Rojo 122","Rojo Sandia 103"]},{ _id: 'Frontier', proovedor: 'Cuero Texa', seq: 10, colores: ["Negro","Café","Gris"]},{ _id: 'Tacto Plus', proovedor: 'Vc. Industrial', seq: 11, colores: ["Burdeo","Café Moro","Naranjo","Negro","Gris","Verde Pistacho","Rojo","Azul Marino","Azul Electrico"]},{ _id: 'Lana VC', proovedor: 'Vc. Industrial', seq: 12, colores: ["Rojo Italiano","café MORO","Gris","Azul Rey","Azul Marino","Azul sandia","Naranja","Burdeo","Verde","Negro","Café"]},{ _id: 'Cuero Natural', proovedor: 'Cuero Natural', seq: 13, colores: ["Blanco","negro"]},{ _id: 'Liberty', proovedor: 'Cuero Texa', seq: 14, colores: ["Negro","Guinda","Café","Blanco","Amarillo","Beige","Mafil","Gris Acero","Gris Perla ","Gris Humo","Morado","Verde Pistacho","Rojo","Azul","Celeste","Azul Blue","Orange","Salmon"]},{ _id: 'Normandia', proovedor: 'Cuero Texa', seq: 15, colores: ["rojo 26-05","gris 26-14","lila 26-06","café 26-07","26-04","26-08","plus 26-28","plus 26-29","plus 26-26","plus 26-22","plus 26-40","plus 26-21","plus 26-24","plus 26-39","plus 26-32-1","plus 26-25"]},{ _id: 'Versalle', proovedor: 'Cuero Texa', seq: 16, colores: ["25-2105","25-2175","25-2195","25-2144","25-2191","25-2136"]},{ _id: 'Paris', proovedor: 'Cuero Texa', seq: 17, colores: ["15-173","15-03","15-21","15-41","15-11","15-04","15-44","15-05","15-10"]}] );

[{ _id: 'Glock', proovedor: 'Contatto', seq: 1, colores: ["Azul","Azul Caribe","Azul Lago","Azul Piedra-811","Caoba","Esmeralda","Gris Acero","Gris Perla","Negro","Mango","Manzana","Plomo","Rojo","Verde Pino"]},{ _id: 'Escorial', proovedor: 'Contatto', seq: 2, colores: ["Almendra","Arrecife","Azafran","Azul Caribe","Azul Lago","azul Rey","Blue","Burdeo","Caoba","Esmeralda","Gris Acero","Gris Mouse","Gris Nevado","Gris Perla ","Gris Raton","Mango","Naranja","Navy","Negro","Pera","Rojo","Scarlati","Tabaco","Tilo","Tomate","Verde","Vino"]},{ _id: 'Maroqui', proovedor: 'Contatto', seq: 3, colores: []},{ _id: 'Venetto', proovedor: 'Contatto', seq: 4, colores: ["Amarillo","Azul Caribe","Azul Rey","Café","Gris","Naranjo","Negro","Rojo","Verde","Verde Pistacho"]},{ _id: 'Venezia', proovedor: 'Contatto', seq: 5, colores: ["Azul -821","Azul Piedra-811","Bicolor Amarillo -52","Bicolor Azul Noche-53","Bicolor Azul-31","Gris Oscuro-78","Gris-72"]},{ _id: 'Elasticity', proovedor: 'Cerantola', seq: 6, colores: ["Azul 21","Azul 39","Azul 67","Gris 14","Gris 64","Marron 07","Naranjo 65","Negro 60","Rojo 68","Verde 66"]},{ _id: 'Pegaso', proovedor: 'Cerantola', seq: 7, colores: ["Negro 562","Rojo 582","Naranjo 558","Pistacho 569","Café 552"]},{ _id: 'Coventry', proovedor: 'Cerantola', seq: 8, colores: ["Negro"]},{ _id: 'Renna', proovedor: 'Cerantola', seq: 9, colores: ["Amarillo 86","Azul 957","Azul Marino 8","Beige 730","Blanco Invierno 126","Burdeo 7","Celeste Azul 120","Grafito 620","Lila 83","Morado 82","Negro 9","Pistacho 71","Rojo 122","Rojo Sandia 103"]},{ _id: 'Frontier', proovedor: 'Cuero Texa', seq: 10, colores: ["Negro","Café","Gris"]},{ _id: 'Tacto Plus', proovedor: 'Vc. Industrial', seq: 11, colores: ["Burdeo","Café Moro","Naranjo","Negro","Gris","Verde Pistacho","Rojo","Azul Marino","Azul Electrico"]},{ _id: 'Lana VC', proovedor: 'Vc. Industrial', seq: 12, colores: ["Rojo Italiano","café MORO","Gris","Azul Rey","Azul Marino","Azul sandia","Naranja","Burdeo","Verde","Negro","Café"]},{ _id: 'Cuero Natural', proovedor: 'Cuero Natural', seq: 13, colores: ["Blanco","negro"]},{ _id: 'Liberty', proovedor: 'Cuero Texa', seq: 14, colores: ["Negro","Guinda","Café","Blanco","Amarillo","Beige","Mafil","Gris Acero","Gris Perla ","Gris Humo","Morado","Verde Pistacho","Rojo","Azul","Celeste","Azul Blue","Orange","Salmon"]},{ _id: 'Normandia', proovedor: 'Cuero Texa', seq: 15, colores: ["rojo 26-05","gris 26-14","lila 26-06","café 26-07","26-04","26-08","plus 26-28","plus 26-29","plus 26-26","plus 26-22","plus 26-40","plus 26-21","plus 26-24","plus 26-39","plus 26-32-1","plus 26-25"]},{ _id: 'Versalle', proovedor: 'Cuero Texa', seq: 16, colores: ["25-2105","25-2175","25-2195","25-2144","25-2191","25-2136"]},{ _id: 'Paris', proovedor: 'Cuero Texa', seq: 17, colores: ["15-173","15-03","15-21","15-41","15-11","15-04","15-44","15-05","15-10"]}]

db.silla_tapizes_fabricas.insert( [{ _id: 'TF1', seq: 1, colores:  ["Negro"]},{ _id: 'TF2', seq: 2, colores:  ["Rojo"]},{ _id: 'TF3', seq: 3, colores:  ["Azul"]},{ _id: 'TF4', seq: 4, colores:  ["Café"]},{ _id: 'TF5', seq: 5, colores:  ["Gris"]},{ _id: 'TF6', seq: 6, colores:  ["Blanco"]},{ _id: 'TF7', seq: 7, colores:  []},{ _id: 'TF8', seq: 8, colores:  []},{ _id: 'TF9', seq: 9, colores:  []},{ _id: 'TF10', seq: 10, colores:  []},{ _id: 'TF11', seq: 11, colores:  ["Negro","Rojo","Azul"]},{ _id: 'TF12', seq: 12, colores:  ["Negro","Gris"]},{ _id: 'TF13', seq: 13, colores:  ["Negro","Azul"]}, { _id: 'TF14', seq: 14, colores:  ["Negro","Rojo"]} ] );
{ _id: 'TF1', seq: 1, colores:  ["Negro"]},{ _id: 'TF2', seq: 2, colores:  ["Rojo"]},{ _id: 'TF3', seq: 3, colores:  ["Azul"]},{ _id: 'TF4', seq: 4, colores:  ["Café"]},{ _id: 'TF5', seq: 5, colores:  ["Gris"]},{ _id: 'TF6', seq: 6, colores:  ["Blanco"]},{ _id: 'TF7', seq: 7, colores:  []},{ _id: 'TF8', seq: 8, colores:  []},{ _id: 'TF9', seq: 9, colores:  []},{ _id: 'TF10', seq: 10, colores:  []},{ _id: 'TF11', seq: 11, colores:  ["Negro","Rojo","Azul"]},{ _id: 'TF12', seq: 12, colores:  ["Negro","Gris"]},{ _id: 'TF13', seq: 13, colores:  ["Negro","Azul"]}, { _id: 'TF14', seq: 14, colores:  ["Negro","Rojo"]}

db.silla_cartoons.insert( { _id: 'D', seq: 1, colores: ["Butterfly","Liga","Pony","Suerstart","Turbo" ]} );

{ _id: 'D', seq: 1, colores: ["Butterfly","Liga","Pony","Suerstart","Turbo" ]}

db.silla_mallas.insert( [ { _id: 'M1', seq: 1, colores: ["Negra"]},{ _id: 'M2', seq: 2, colores: ["Blanca"]},{ _id: 'M3', seq: 3, colores: ["Azul"]},{ _id: 'M4', seq: 4, colores: ["Gris"]},{ _id: 'M5', seq: 5, colores: ["Verde"]},{ _id: 'M6', seq: 6, colores: ["Roja"]},{ _id: 'M7', seq: 7, colores: ["Naranja"]},{ _id: 'M8', seq: 8, colores: []},{ _id: 'M9', seq: 9, colores: []},{ _id: 'M10', seq: 10, colores: []}, { _id: 'M11', seq: 11, colores: ["Negro","Blanco","Azul","Gris","Roja"]},  { _id: 'M12', seq: 12, colores: ["Azul claro","Naranjo","Gris"]},{ _id: 'M13', seq: 13, colores: ["Negro","Blanco"]},{ _id: 'M14', seq: 14, colores: ["Negro","Gris"]} ] ); 

{ _id: 'M1', seq: 1, colores: ["Negra"]},{ _id: 'M2', seq: 2, colores: ["Blanca"]},{ _id: 'M3', seq: 3, colores: ["Azul"]},{ _id: 'M4', seq: 4, colores: ["Gris"]},{ _id: 'M5', seq: 5, colores: ["Verde"]},{ _id: 'M6', seq: 6, colores: ["Roja"]},{ _id: 'M7', seq: 7, colores: ["Naranja"]},{ _id: 'M8', seq: 8, colores: []},{ _id: 'M9', seq: 9, colores: []},{ _id: 'M10', seq: 10, colores: []}, { _id: 'M11', seq: 11, colores: ["Negro","Blanco","Azul","Gris","Roja"]},  { _id: 'M12', seq: 12, colores: ["Azul claro","Naranjo","Gris"]},{ _id: 'M13', seq: 13, colores: ["Negro","Blanco"]},{ _id: 'M14', seq: 14, colores: ["Negro","Gris"]},

db.silla_tapices_telas.insert( [{ _id: 'T1', seq: 1, colores: ["Glock"]},{ _id: 'T2', seq: 2, colores: ["Escorial"]},{ _id: 'T3', seq: 3, colores: ["Maroqui"]},{ _id: 'T4', seq: 4, colores: ["Venetto"]},{ _id: 'T5', seq: 5, colores: ["Venezia"]},{ _id: 'T6', seq: 6, colores: ["Elasticity"]},{ _id: 'T7', seq: 7, colores: ["Renna"]},{ _id: 'T8', seq: 8, colores: ["Pegaso"]},{ _id: 'T9', seq: 9, colores: ["Serrano"]},{ _id: 'T10', seq: 10, colores: ["Frontier"]},{ _id: 'T11', seq: 11, colores: ["Tacto Plus"]},{ _id: 'T12', seq: 12, colores: ["Cuero Natural"]},{ _id: 'T13', seq: 13, colores: ["Liberty"]},{ _id: 'T14', seq: 14, colores: ["Normandia"]},{ _id: 'T15', seq: 15, colores: ["Versalle"]},{ _id: 'T16', seq: 16, colores: ["Paris"]},{ _id: 'T17', seq: 17, colores: ["Coventry"]},{ _id: 'T18', seq: 18, colores: []},{ _id: 'T19', seq: 19, colores: []},{ _id: 'T20', seq: 20, colores: ["Glock","Escorial","Maroqui","Venetto","Venezia"]},{ _id: 'T21', seq: 21, colores: ["Elasticity","Renna","Pegaso","Coventry"]},    { _id: 'T22', seq: 22, colores: ["Renna","Pegaso","Coventry"]},    { _id: 'T23', seq: 23, colores: ["Liberty","Normandia","Versalle","Paris"]},    { _id: 'T24', seq: 24, colores: ["Hilat","Tacto Plus","Serrano","Renna","Lana VC"]}]);

[{ _id: 'T1', seq: 1, colores: ["Glock"]},{ _id: 'T2', seq: 2, colores: ["Escorial"]},{ _id: 'T3', seq: 3, colores: ["Maroqui"]},{ _id: 'T4', seq: 4, colores: ["Venetto"]},{ _id: 'T5', seq: 5, colores: ["Venezia"]},{ _id: 'T6', seq: 6, colores: ["Elasticity"]},{ _id: 'T7', seq: 7, colores: ["Renna"]},{ _id: 'T8', seq: 8, colores: ["Pegaso"]},{ _id: 'T9', seq: 9, colores: ["Serrano"]},{ _id: 'T10', seq: 10, colores: ["Frontier"]},{ _id: 'T11', seq: 11, colores: ["Tacto Plus"]},{ _id: 'T12', seq: 12, colores: ["Cuero Natural"]},{ _id: 'T13', seq: 13, colores: ["Liberty"]},{ _id: 'T14', seq: 14, colores: ["Normandia"]},{ _id: 'T15', seq: 15, colores: ["Versalle"]},{ _id: 'T16', seq: 16, colores: ["Paris"]},{ _id: 'T17', seq: 17, colores: ["Coventry"]},{ _id: 'T18', seq: 18, colores: []},{ _id: 'T19', seq: 19, colores: []},{ _id: 'T20', seq: 20, colores: ["Glock","Escorial","Maroqui","Venetto","Venezia"]},{ _id: 'T21', seq: 21, colores: ["Elasticity","Renna","Pegaso","Coventry"]},    { _id: 'T22', seq: 22, colores: ["Renna","Pegaso","Coventry"]},    { _id: 'T23', seq: 23, colores: ["Liberty","Normandia","Versalle","Paris"]},    { _id: 'T24', seq: 24, colores: ["Hilat","Tacto Plus","Serrano","Renna","Lana VC"]}]

db.silla_ecocuero.insert( [{ _id: 'Eco1', seq: 1, colores: ["Negro"]},{ _id: 'Eco2', seq: 2, colores: ["Blanco"]},{ _id: 'Eco3', seq: 3, colores: ["Grafito"]},{ _id: 'Eco4', seq: 4, colores: ["Arena"]},{ _id: 'Eco5', seq: 5, colores: ["Cuero"]},{ _id: 'Eco6', seq: 6, colores: ["Negro","Blanco","Grafito","Arena"]},  { _id: 'Eco7', seq: 7, colores: ["Negro","Blanco"]},    { _id: 'Eco8', seq: 8, colores: ["Negro","Café"]},    { _id: 'Eco9', seq: 9, colores: []}] );
[{ _id: 'Eco1', seq: 1, colores: ["Negro"]},{ _id: 'Eco2', seq: 2, colores: ["Blanco"]},{ _id: 'Eco3', seq: 3, colores: ["Grafito"]},{ _id: 'Eco4', seq: 4, colores: ["Arena"]},{ _id: 'Eco5', seq: 5, colores: ["Cuero"]},{ _id: 'Eco6', seq: 6, colores: ["Negro","Blanco","Grafito","Arena"]},  { _id: 'Eco7', seq: 7, colores: ["Negro","Blanco"]},    { _id: 'Eco8', seq: 8, colores: ["Negro","Café"]},    { _id: 'Eco9', seq: 9, colores: []}]

db.silla_polipropileno.insert( [{ _id: 'P1', seq: 1, colores: ["Negro"]},{ _id: 'P2', seq: 2, colores: ["Blanco"]},{ _id: 'P3', seq: 3, colores: ["Café"]},{ _id: 'P4', seq: 4, colores: ["Gris"]},{ _id: 'P5', seq: 5, colores: ["Azul"]},{ _id: 'P6', seq: 6, colores: ["Beige"]},{ _id: 'P7', seq: 7, colores: ["Amarillo"]},{ _id: 'P8', seq: 8, colores: ["Naranjo"]},{ _id: 'P9', seq: 9, colores: ["Rojo"]},{ _id: 'P10', seq: 10, colores: ["Verde"]},{ _id: 'P11', seq: 11, colores: ["Burdeo"]},{ _id: 'P12', seq: 12, colores: ["Marengo"]},{ _id: 'P13', seq: 13, colores: ["Sandia"]},{ _id: 'P14', seq: 14, colores: ["Guinda"]},{ _id: 'P15', seq: 15, colores: ["Arena"]},{ _id: 'P16', seq: 16, colores: ["Violeta"]},{ _id: 'P17', seq: 17, colores: ["Grafito"]},{ _id: 'P18', seq: 18, colores: ["Gris Claro"]},{ _id: 'P19', seq: 19, colores: []},{ _id: 'P20', seq: 20, colores: []},{ _id: 'P21', seq: 21, colores: ["Negro","Blanco","Azul","Beige","Naranjo","Rojo","Verde"]},  { _id: 'P22', seq: 22, colores: ["Negro","Blanco","Gris","Azul","Naranjo","Rojo","Verde","Arena"]},    { _id: 'P23', seq: 23, colores: ["Negro","Blanco","Gris"]},  { _id: 'P24', seq: 24, colores: ["Negro","Gris","Azul","Rojo","Verde"]},  { _id: 'P25', seq: 25, colores: ["Negro","Blanco","Gris","Azul","Naranjo","Verde","Arena"]},  { _id: 'P26', seq: 26, colores: ["Negro","Blanco","Café","Azul","Rojo","Violeta"]},  { _id: 'P27', seq: 27, colores: ["Negro","Blanco","Café","Azul","Rojo","Violeta"]},  { _id: 'P28', seq: 28, colores: ["Negro","Gris","Azul","Rojo"]},  { _id: 'P29', seq: 29, colores: ["Beige","Grafito"]},  { _id: 'P30', seq: 30, colores: ["Negro","Sandia"]},  { _id: 'P31', seq: 31, colores: ["Negro","Blanco"]},  { _id: 'P32', seq: 32, colores: ["Negro","Verde"]},  { _id: 'P33', seq: 33, colores: ["Negro","Verde","Sandia"]},    { _id: 'P34', seq: 34, colores: ["Café","Azul","Naranjo","Verde","Guinda"]},  { _id: 'P35', seq: 35, colores: ["Café","Azul","Guinda"]},  { _id: 'P36', seq: 36, colores: ["Negro","Blanco","Azul","Amarillo","Naranjo","Rojo","Verde"]},    { _id: 'P37', seq: 37, colores: ["Negro","Azul","Amarillo","Naranjo","Gris"]},  { _id: 'P38', seq: 38, colores: ["Blanco","Gris","Verde"]},  { _id: 'P39', seq: 39, colores: ["Negro","Rojo"]},  { _id: 'P40', seq: 40, colores: ["Negro","Blanco","Rojo"]},  { _id: 'P41', seq: 41, colores: ["Azul","Blanco","Rojo"]},  { _id: 'P42', seq: 42, colores: ["Negro","Azul"]},  { _id: 'P43', seq: 43, colores: ["Negro","Gris","Azul","Amarillo","Naranjo","Rojo","Burdeo","Verde Pistacho","Verde Manzana","Verde Esmeralda"]},    { _id: 'P44', seq: 44, colores: ["Negro","Gris","Azul","Blanco","Rojo","Verde Pistacho"]},  { _id: 'P45', seq: 45, colores: ["Azul","Verde"]}] );

[{ _id: 'P1', seq: 1, colores: ["Negro"]},{ _id: 'P2', seq: 2, colores: ["Blanco"]},{ _id: 'P3', seq: 3, colores: ["Café"]},{ _id: 'P4', seq: 4, colores: ["Gris"]},{ _id: 'P5', seq: 5, colores: ["Azul"]},{ _id: 'P6', seq: 6, colores: ["Beige"]},{ _id: 'P7', seq: 7, colores: ["Amarillo"]},{ _id: 'P8', seq: 8, colores: ["Naranjo"]},{ _id: 'P9', seq: 9, colores: ["Rojo"]},{ _id: 'P10', seq: 10, colores: ["Verde"]},{ _id: 'P11', seq: 11, colores: ["Burdeo"]},{ _id: 'P12', seq: 12, colores: ["Marengo"]},{ _id: 'P13', seq: 13, colores: ["Sandia"]},{ _id: 'P14', seq: 14, colores: ["Guinda"]},{ _id: 'P15', seq: 15, colores: ["Arena"]},{ _id: 'P16', seq: 16, colores: ["Violeta"]},{ _id: 'P17', seq: 17, colores: ["Grafito"]},{ _id: 'P18', seq: 18, colores: ["Gris Claro"]},{ _id: 'P19', seq: 19, colores: []},{ _id: 'P20', seq: 20, colores: []},{ _id: 'P21', seq: 21, colores: ["Negro","Blanco","Azul","Beige","Naranjo","Rojo","Verde"]},  { _id: 'P22', seq: 22, colores: ["Negro","Blanco","Gris","Azul","Naranjo","Rojo","Verde","Arena"]},    { _id: 'P23', seq: 23, colores: ["Negro","Blanco","Gris"]},  { _id: 'P24', seq: 24, colores: ["Negro","Gris","Azul","Rojo","Verde"]},  { _id: 'P25', seq: 25, colores: ["Negro","Blanco","Gris","Azul","Naranjo","Verde","Arena"]},  { _id: 'P26', seq: 26, colores: ["Negro","Blanco","Café","Azul","Rojo","Violeta"]},  { _id: 'P27', seq: 27, colores: ["Negro","Blanco","Café","Azul","Rojo","Violeta"]},  { _id: 'P28', seq: 28, colores: ["Negro","Gris","Azul","Rojo"]},  { _id: 'P29', seq: 29, colores: ["Beige","Grafito"]},  { _id: 'P30', seq: 30, colores: ["Negro","Sandia"]},  { _id: 'P31', seq: 31, colores: ["Negro","Blanco"]},  { _id: 'P32', seq: 32, colores: ["Negro","Verde"]},  { _id: 'P33', seq: 33, colores: ["Negro","Verde","Sandia"]},    { _id: 'P34', seq: 34, colores: ["Café","Azul","Naranjo","Verde","Guinda"]},  { _id: 'P35', seq: 35, colores: ["Café","Azul","Guinda"]},  { _id: 'P36', seq: 36, colores: ["Negro","Blanco","Azul","Amarillo","Naranjo","Rojo","Verde"]},    { _id: 'P37', seq: 37, colores: ["Negro","Azul","Amarillo","Naranjo","Gris"]},  { _id: 'P38', seq: 38, colores: ["Blanco","Gris","Verde"]},  { _id: 'P39', seq: 39, colores: ["Negro","Rojo"]},  { _id: 'P40', seq: 40, colores: ["Negro","Blanco","Rojo"]},  { _id: 'P41', seq: 41, colores: ["Azul","Blanco","Rojo"]},  { _id: 'P42', seq: 42, colores: ["Negro","Azul"]},  { _id: 'P43', seq: 43, colores: ["Negro","Gris","Azul","Amarillo","Naranjo","Rojo","Burdeo","Verde Pistacho","Verde Manzana","Verde Esmeralda"]},    { _id: 'P44', seq: 44, colores: ["Negro","Gris","Azul","Blanco","Rojo","Verde Pistacho"]},  { _id: 'P45', seq: 45, colores: ["Azul","Verde"]}]

db.silla_bases.insert( [{ _id: 'B1', seq: 1, colores: ["Negro"]},{ _id: 'B2', seq: 2, colores: ["Aluminizada"]},{ _id: 'B3', seq: 3, colores: ["Cromada"]},{ _id: 'B4', seq: 4, colores: ["Blanca"]},{ _id: 'B5', seq: 5, colores: ["Charcole"]},{ _id: 'B6', seq: 6, colores: ["Gris"]},{ _id: 'B7', seq: 7, colores: ["Madera"]},{ _id: 'B8', seq: 8, colores: []},{ _id: 'B9', seq: 9, colores: []},{ _id: 'B10', seq: 10, colores: []},{ _id: 'B11', seq: 11, colores: []},{ _id: 'B12', seq: 12, colores: ["Negro","Aluminizada"   ]},  { _id: 'B13', seq: 13, colores: ["Negro","Cromada" ]},    { _id: 'B14', seq: 14, colores: ["Cromada","Aluminizada"]},    { _id: 'B15', seq: 15, colores: ["Negro","Cromada","Gris"]},      { _id: 'B16', seq: 16, colores: ["Blanca","Aluminizada"]},  { _id: 'B17', seq: 17, colores: ["Gris","Cromada"]},  { _id: 'B18', seq: 18, colores: ["Aluminio","Charcole"]},  { _id: 'B19', seq: 19, colores: ["Negro","Aluminio","Cromada"]}] );
